...
<div class="relative bg-[#f4f2eb] lg:bg-transparent" data-carousel>
	<div class="flex gap-[30px] justify-center items-center">
		...
		<div class="w-[1200px] max-w-full overflow-hidden" data-carousel-viewport>
			<div class="flex gap-[30px] transition-transform duration-300 ease-out" data-carousel-track>
				<?php foreach ($articles as $article) : ?>
					...
					?>
					<article class="max-w-[380px] flex-shrink-0 overflow-hidden bg-white shadow-[0_12px_26px_rgba(0,0,0,0.12)]">
						...
						<div class="p-[28px_30px_40px]">
							<h3 class="mb-[16px] text-[20px] leading-[1.45] tracking-[-0.02em] text-[#1f1c1a]"><?php echo esc_html($title); ?></h3>
							<p class="mb-[25px] text-[12px] text-[rgba(31,28,26,0.55)]"><?php echo esc_html($location); ?></p>
							<span class="inline-flex h-[20px] items-center bg-[#6eba38] px-[10px] text-[12px] font-bold text-white"><?php echo esc_html($tag); ?></span>
						</div>
					</article>
				<?php endforeach; ?>
			</div>
	...
	<div class="mt-[30px] flex items-center justify-center gap-[10px]" data-carousel-dots>
	</div>
</div>