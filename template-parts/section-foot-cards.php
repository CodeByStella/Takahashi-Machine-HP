...
<section class="section px-0">
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0">
    <?php foreach ($foot_cards as $foot_card): ?>
      <div class="group relative aspect-[533/400] overflow-hidden cursor-pointer">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-white px-4">
          <p class="text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] 2xl:text-[16px] opacity-50"><?php echo esc_html($foot_card['eyebrow']); ?></p>
          <h3 class="mt-[12px] sm:mt-[14px] md:mt-[16px] lg:mt-[18px] 2xl:mt-[20px] text-[22px] sm:text-[24px] md:text-[26px] lg:text-[28px] 2xl:text-[30px] text-center"><?php echo esc_html($foot_card['title']); ?></h3>
        </div>
