...
$class = trim('relative inline-flex items-center justify-between rounded-full border border-white/15 bg-[#d2b07b] bg-cover bg-center bg-no-repeat h-[44px] w-full max-w-[200px] px-[14px] text-[12px] font-bold tracking-[0.08em] text-white transition-all duration-300 hover:scale-105 sm:h-[48px] sm:max-w-[220px] sm:px-[16px] sm:text-[13px] md:h-[56px] md:max-w-[266px] md:px-[18px] md:text-[14px] ' . $extra_class);
?>
