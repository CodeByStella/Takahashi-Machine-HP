			...
			<div class="relative aspect-[1330/990] sm:aspect-[1600/622] w-full">
				...
				<div class="relative z-10 h-full text-white px-[20px] sm:px-[40px] md:px-[80px] lg:px-[150px] xl:px-[180px] 2xl:pl-[200px] pt-[30px] sm:pt-[50px] md:pt-[60px] lg:pt-[40px] xl:pt-[100px] 2xl:pt-[120px]">
					<p class="mb-[12px] sm:mb-[16px] md:mb-[10px] 2xl:mb-[24px] inline-flex items-center gap-[8px] md:gap-[10px] text-white/75">
						<img class="top-kicker-icon w-[12px] sm:w-[14px] md:w-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/top/product-icon.svg'); ?>" alt="" loading="lazy">
						<span class="text-[14px] sm:text-[16px] md:text-[18px] 2xl:text-[20px] text-[#6EBA38] font-bold"><?php esc_html_e('Product', 'mytheme'); ?></span>
					</p>
					...
					<p class="mb-[24px] sm:mb-[30px] md:mb-[20px] 2xl:mb-[44px] text-[13px] sm:text-[14px] md:text-[15px] 2xl:text-[16px] leading-[1.8] text-white/85 font-regular">
			...
			<div class="relative aspect-[1330/990] sm:aspect-[1600/462] w-full">
				...
				<div class="relative z-10 h-full text-white px-[20px] sm:px-[40px] md:px-[80px] lg:px-[150px] xl:px-[180px] 2xl:px-[200px] pt-[30px] sm:pt-[50px] md:pt-[60px] lg:pt-[40px] xl:pt-[100px] 2xl:pt-[120px]">
					<p class="mb-[12px] sm:mb-[16px] md:mb-[10px] 2xl:mb-[22px] inline-flex items-center gap-[8px] md:gap-[10px] text-white/75">
						<img class="existing-product-kicker-icon w-[12px] sm:w-[14px] md:w-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/top/product-icon.svg'); ?>" alt="" loading="lazy">
			...
			<div class="relative aspect-[1330/990] sm:aspect-[1600/622] w-full">
				...
				<div class="relative z-10 h-full px-[20px] sm:px-[40px] md:px-[80px] lg:px-[150px] xl:px-[180px] 2xl:pl-[200px] pt-[30px] sm:pt-[50px] md:pt-[60px] lg:pt-[40px] xl:pt-[100px] 2xl:pt-[120px]">
					<p class="mb-[12px] sm:mb-[16px] md:mb-[10px] 2xl:mb-[24px] inline-flex items-center gap-[8px] md:gap-[10px] text-[#1f1c1a]">
						<img class="used-product-kicker-icon w-[12px] sm:w-[14px] md:w-[30px]" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/top/product-icon.svg'); ?>" alt="" loading="lazy">
						<span class="text-[14px] sm:text-[16px] md:text-[18px] 2xl:text-[20px] text-[#6EBA38] font-bold"><?php esc_html_e('Used Product', 'mytheme'); ?></span>
					</p>
					...
					<div class="flex flex-col sm:flex-row justify-between w-full gap-[16px] sm:gap-[20px] 2xl:gap-[24px] items-start sm:items-end">
						<p class="text-[13px] sm:text-[14px] md:text-[15px] 2xl:text-[16px] leading-[1.8] text-[#1f1c1a] opacity-70 font-regular">
	...
	<section class="section relative pb-[50px] sm:pb-[60px] md:pb-[70px] lg:pb-[80px] xl:pb-[90px] 2xl:pb-[100px]">
		<div class="relative flex justify-center h-full w-full aspect-[1600/577]">
			...
			<div class="text-center mt-[46px] sm:mt-[120px] md:mt-[160px] xl:mt-[210px] 2xl:mt-[230px] px-4">
				...
				<p class="mt-[12px] sm:mt-[38px] md:mt-4 2xl:mt-[58px] inline-block text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] 2xl:text-[24px] text-primary font-bold">
		...
		<?php foreach ($feature_cards as $feature_card) : ?>
			...
			<<?php echo $card_tag; ?> class="group relative aspect-square overflow-hidden cursor-pointer block" <?php echo $card_attr; ?>>
				...
				<div class="absolute inset-0 flex flex-col items-center justify-center text-white px-4">
					<p class="text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] 2xl:text-[16px] opacity-50 font-medium"><?php echo esc_html($feature_card['eyebrow']); ?></p>
					<h3 class="mt-[10px] sm:mt-[12px] md:mt-[15px] lg:mt-[17px] 2xl:mt-[20px] text-[20px] sm:text-[22px] md:text-[25px] lg:text-[27px] 2xl:text-[30px] font-bold"><?php echo esc_html($feature_card['title']); ?></h3>
				</div>
