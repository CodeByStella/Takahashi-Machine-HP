...
<section class="about-hero relative ">
    <div class="aspect-[1600/577] relative">
        ...
        <div class="w-full max-w-6xl mx-auto flex justify-center items-end">
            <p class="text-[14px] opacity-70 mt-[20px] w-full text-right pr-30 font-regular"><a href="<?php echo esc_url(home_url('/')); ?>">TOP</a> &gt; <a href="<?php echo esc_url($news_url); ?>">お知らせ</a> &gt;
                <?php the_title(); ?>
            </p>
        </div>
        <div class=" w-full py-[42px] max-w-6xl mx-auto px-10">
            <div class="flex justify-start ">
                <div class="flex flex-row gap-[12px]">
                    ...
                    <h1 class="text-[16px] font-bold leading-[1.1]">
                        <?php the_title(); ?>
                    </h1>
                </div>
            </div>
            <p class="text-[20px] lg:text-[30px] font-medium leading-[1.5] mt-[20px]">
...
<section class=" ">
    <div class="max-w-6xl mx-auto px-10 mt-[65px] border-t-2 flex justify-center py-[20px]">
        <div
            ...
            <p class="text-[14px] font-medium text-white text-center ml-[60px]">BACK TO LIST <span class="font-bold text-white ml-[50px]">></span></p>
        </div>
    </div>
</section>
<!-- BackTop section end -->
