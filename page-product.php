...
<section class="product-hero relative px-0">
  <div class="aspect-[375/600] sm:aspect-[768/600] md:aspect-[1024/500] lg:aspect-[1440/550] 2xl:aspect-[1600/577] relative w-full">
    ...
    <div class="w-full py-[24px] sm:py-[30px] md:py-[36px] lg:py-[42px] 2xl:py-[46px]">
      ...
      <p class="text-[11px] sm:text-[12px] md:text-[13px] 2xl:text-[14px] opacity-70 mt-[12px] sm:mt-[16px] md:mt-[20px] w-full text-center md:text-right pr-0 md:pr-15 lg:pr-20 2xl:pr-30">TOP > 製品一覧 > <?php echo esc_html($hero_subtitle); ?></p>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-[20px] lg:gap-[25px] 2xl:gap-[30px] mx-auto max-w-[320px] sm:max-w-none w-full sm:w-fit px-4 sm:px-0 mt-[30px] sm:mt-[40px] lg:mt-[45px] 2xl:mt-[50px] pb-6 sm:pb-8 md:pb-0">
      <a href="<?php echo esc_url($product_base_url . '?id=existing'); ?>" class="bg-secondary hover:bg-primary text-white w-full sm:w-[240px] md:w-[280px] lg:w-[340px] 2xl:w-[395px] aspect-[320/120] sm:aspect-[395/120] relative rounded-[12px] flex flex-col justify-center items-center gap-2 cursor-pointer transition-colors<?php echo $product_id === 'existing' ? ' ring-2 ring-primary' : ''; ?>">
      ...
      <a href="<?php echo esc_url($product_base_url . '?id=used'); ?>" class="bg-secondary hover:bg-primary text-white w-full sm:w-[240px] md:w-[280px] lg:w-[340px] 2xl:w-[395px] aspect-[320/120] sm:aspect-[395/120] relative rounded-[12px] flex flex-col justify-center items-center gap-2 cursor-pointer transition-colors<?php echo $product_id === 'used' ? ' ring-2 ring-primary' : ''; ?>">
...
(function(){
  document.querySelectorAll('.product-card-gallery').forEach(function(gallery){
    ...
    function getSelectedUrl(){ return gallery.getAttribute('data-selected-url') || main.src; }
    function setSelectedUrl(url){ gallery.setAttribute('data-selected-url', url); }
    function setMainSrc(url){ main.src = url; }
    thumbs.forEach(function(btn){
      ...
      btn.addEventListener('mouseenter', function(){ setMainSrc(img.src); });
      btn.addEventListener('mouseleave', function(){ setMainSrc(getSelectedUrl()); });
    });
  });
