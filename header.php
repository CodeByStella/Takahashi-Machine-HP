...
?>
<!doctype html>
<html <?php language_attributes(); ?> style="font-family: 'Ubuntu', 'Noto Sans CJK JP', 'Hiragino Kaku Gothic ProN', 'Yu Gothic', Meiryo, sans-serif !important">
...
<body <?php body_class(); ?> style="font-family: 'Ubuntu', 'Noto Sans CJK JP', 'Hiragino Kaku Gothic ProN', 'Yu Gothic', Meiryo, sans-serif !important">

	<body>
		<div id="fb-root"></div>
		<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v25.0"></script>
		<?php wp_body_open(); ?>
					...
					<div class="flex flex-col items-end h-full lg:pt-0 lg:pb-0">
						<div class="site-header__right">
							<div class="header-ctas lg:gap-[10px]" aria-label="<?php esc_attr_e('Contact shortcuts', 'mytheme'); ?>">
								...
								<a class="cta-pill cta-pill--download lg:w-[200px] lg:h-[40px] lg:rounded-full" href="<?php echo esc_url(mytheme_get_download_url()); ?>"<?php echo ( get_theme_mod('mytheme_download_file_id', 0) > 0 ) ? ' download' : ''; ?>>
