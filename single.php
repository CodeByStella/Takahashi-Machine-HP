		...
		<section class="about-hero relative">
			<div class="min-h-[300px] sm:min-h-[360px] md:min-h-[400px] relative w-full flex flex-col justify-center">
				...
				<div class="relative z-0 w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-[24px] sm:py-[30px] md:py-[36px] lg:py-[42px] 2xl:py-[46px]">
					<p class="text-[13px] sm:text-[12px] md:text-[13px] 2xl:text-[14px] opacity-70 w-full md:text-right pr-0 md:pr-4 lg:pr-8 2xl:pr-12 truncate font-regular" title="TOP > お知らせ > <?php echo esc_attr(get_the_title()); ?>">
					...
					<div class="w-full pt-[16px] sm:pt-[20px] md:pt-[24px]">
						<div class="flex flex-wrap items-center gap-x-[12px] gap-y-2">
							<span class="shrink-0 bg-secondary px-[14px] py-[4px] text-[14px] font-medium leading-none text-white">
								<?php echo esc_html($category_name); ?>
							</span>
							<h1 class="min-w-0 text-[22px] sm:text-[18px] md:text-[20px] lg:text-[22px] 2xl:text-[24px] font-bold leading-[1.3] break-words">
								<?php the_title(); ?>
							</h1>
						</div>
						<p class="text-[16px] sm:text-[13px] 2xl:text-[14px] text-primary/60 mt-[20px] font-regular">
